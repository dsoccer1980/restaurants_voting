...
public class VoteRestController {
    ...
    public ResponseEntity<Void> createWithLocation(
        ...
        Vote created = voteService.save(AuthorizedUser.id(), restaurantId, date);
